...
def run_the_app():
    ...
    if uploaded_file:
        ...
        img.save("app/object_detection/images/test.jpg")
        img.close()
        command = "python detect.py --source app/object_detection/images/test.jpg --weights runs/train/cow_det7/weights/best.pt --conf 0.2 --name output --img-size 600"
        subprocess.call(command, shell=True)
        img = Image.open("app/object_detection/output/test.jpg")
